...
function logInfo(msg) {
  console.log(source_default().magentaBright(msg));
}
...
function logError(msg) {
  console.log(source_default().redBright(msg));
}

function logSuccess(msg) {
  console.log(source_default().greenBright(msg));
}

function logErrorAndFail(err) {
  logError(err);
  process.exit(1);
}
...
;// CONCATENATED MODULE: ./src/cvs.js
...
try {
  terminalNotifierPath = (0,external_child_process_namespaceObject.execSync)(`which terminal-notifier`).toString().trim();
